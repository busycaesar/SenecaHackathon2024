...
export default function AboutUs() {
  return (
    <>
      <div>
        <h1 class="text-center text-3xl font-bold mb-3 text-my-red">
          What is Hackathon?
        </h1>
      </div>
      <div class="max-w-lg md:w-full mb-3 md:m-5 lg:max-w-full lg:flex ">
        <div class="bg-gray-200 border-2 border-solid rounded-lg border-my-red p-4 flex flex-col justify-between leading-normal">
          <div class="mb-8">
            ...
            <p class="text-black font-gotham text-base text-lg md:text-justify md:m-5">
      ...
      <div class="max-w-lg md:w-full mb-3 md:m-5 lg:max-w-full lg:flex ">
        ...
        <div class="bg-gray-200 border-2 border-solid rounded-lg border-my-red p-2 md:p-4 flex flex-col justify-between leading-normal">
          <div class="">
        ...
        <div class="flex flex-wrap md:mx-24 mb-12">
          ...
          <div class="w-full md:w-1/2 px-4 mb-8">
            <div class="p-6 bg-white border-solid border-my-red rounded-lg">
              ...
              <p class="mb-4 text-lg text-black leading-loose font-gotham">The Digital Health Hackathon was a 48-hour event where healthcare professionals, software developers, designers, and entrepreneurs collaborated to develop innovative digital solutions to healthcare challenges, working in teams to brainstorm, design, and develop their ideas with support and mentorship from industry experts, and at the end of the event, teams presented their solutions to judges who evaluated them based on innovation, impact, and feasibility. The hackathon was held in Toronto, Canada and was organized by Seneca Polytechnic virtually.</p>
          ...
          <div class="w-full md:w-1/2 px-4 mb-8">
            <div class="p-6 bg-white border-solid border-my-red rounded-lg">
              ...
              <p class="mb-4 text-lg text-black leading-loose font-gotham">Seneca’s COVID-19 Business Response Hackathon was held from June 29 to July 3, 2020, with participation from 440 students, including over 100 Business students from the School of International Business & Management, and featured a virtual opening keynote with the CTO of Microsoft Canada, CEO of Sightline Innovation, and the Director of the Toronto Product Management Association, as well as nine industry sponsors that presented challenges to the participants, with RBC and Lafarge sponsoring and mentoring students for the event </p>
