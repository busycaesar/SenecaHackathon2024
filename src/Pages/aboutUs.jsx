    ...
    <>
      ...
      <div class="max-w-lg w-full m-5 lg:max-w-full lg:flex ">
        ...
        <div class="card border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div class="">
            <div class="text-white font-bold md:text-center text-xl ml-5 mb-2">How it all started</div>
            <p class="text-white text-base md:text-justify m-5">Seneca Hackathon began in July 2020 as a response to the COVID-19 pandemic – gathering passionate students to channel their talents and skills into crafting solutions that will address the challenges brought forth by the pandemic. The success of the first Hackathon paved the way for it to evolve into an annual contest with the goal to tackle the most relevant and pressing issues of our society.  </p>
          </div>
          <div class="flex items-center">
          </div>
        </div>
        ...
        <section class="py-5 w-full m-5">
          <div class="container font-sans px-4 mx-auto bg-gray-200">
            <div class="max-w-4xl mx-auto">
              ...
              <p class="mb-6 text-xl md:text-justify text-black">Our participants are students and alumni of Seneca and its partner institutions with wide-ranging interests and diverse backgrounds united and driven by shared passion for innovation.  </p>
              <h3 class="mb-3 text-xl font-medium underline">The sponsors  </h3>
              <p class="mb-10 text-xl md:text-justify text-black">Our sponsors and partners help us shape our challenge sets according to the theme of the hackathon and extend their resources and expertise in support to the overall success of the event.  </p>
              <h2 class="mb-3 text-2xl text-red-500 italic font-normal font-heading">Our vision </h2>
              <p class="mb-10 text-xl md:text-justify text-black">Empowering innovation, fostering collaboration.</p>
