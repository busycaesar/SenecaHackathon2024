...
function CategorySubChallengeSet() {
  ...
  return (
    ...
    <section className="mx-auto bg-gray-200 p-8 border-solid border-red-700 rounded-2xl shadow-2xl">
      ...
      <h2 className="mb-0 text-lg font-semibold text-gray-700">Problem Statement</h2>
      <div>
      ...
      <div>
      <div className="my-4">
        <h3 className="text-lg font-semibold text-gray-700">Gesture Recognition</h3>
        <p className="text-gray-600">
      ...
      <div>
      <div className="my-4">
        <h3 className="text-lg font-semibold text-gray-700">Voice Recognition</h3>
        <p className="text-gray-600">
      ...
      <div>
      <div className="my-4">
        <h3 className="text-lg font-semibold text-gray-700">Augmented Reality Assistance</h3>
        <p className="text-gray-600">
