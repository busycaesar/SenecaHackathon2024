...
export const findCategoryByName = (challenges, categoryName) => {
  return challenges.find(
    (challenge) => challenge.categoryName === categoryName
  );
};

export const findCategoryIconById = (id) => {
  return CSData.find((challenge) => challenge._id === id);
};
